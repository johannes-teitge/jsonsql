            ...
            var ie = function t(e) {
                ...
                Ie = (P(Oe, [{
					...
					value: function() {
						...
						// Optionen in lokale Variablen übernehmen
						...
						// Klasse "tick" hinzufügen, wenn nicht vorhanden
						if (!this._element.classList.contains("tick"))
							this._element.classList.add("tick");

						// Observer einrichten für Attribut "data-value"
						this._observer = Y(this._element, ["data-value"], function(t) {
							e.value = t;
						});

						// Falls das View-Root-Element nicht dasselbe ist wie this._element,
						// werden dessen Kinder in this._element übernommen
						...
						// Falls keine View-Definition vorhanden ist, wird eine Standard-View gesetzt
						if (!this._viewDefinition.view && !this._viewDefinition.children) {
							this._viewDefinition.view = "text";
						}

						// Updater-Funktion initialisieren
						...
						// Status auf "initialised" setzen
						this._element.dataset.state = "initialised";

						// didInit-Callback aufrufen
						this._didInit(this, this.value);

						// Credits-Link anzeigen, wenn angegeben
						if (this._credits) {
