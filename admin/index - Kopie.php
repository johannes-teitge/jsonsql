...
// Überprüfen, ob der Datenbankpfad existiert
if (empty($database_path) && $page != 'error') {
  // Weiterleitung zur Fehlerseite
  header("Location: /JsonSQL/admin/?page=error");
  $_SESSION['error_code'] = 404;
  $_SESSION['error_message'] = "Datenbankpfad <strong>".$database_path."</strong> nicht gefunden oder ungültig!";
  exit; // Stoppe den weiteren Ablauf
}
...
if (isset($_SESSION['authenticated']) && $_SESSION['authenticated'] === true) {
    $debugger->dump($settings,$_SESSION);
} else {
}
